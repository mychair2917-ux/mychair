...
class TestDirectInviteProvision:
    ...
    def test_super_admin_creating_staff_uses_direct_setup(self):
        assert uses_direct_password_provisioning("super_admin", ROLE_EMPLOYEE)
        assert uses_direct_password_provisioning("super_admin", ROLE_SALON_MANAGER)
