export const API_PATHS = {
  ...
  APPOINTMENTS: {
    ...
    CLIENTS_GENERATE_ID: '/appointments/clients/generate-id',
  ...
  CUSTOMER_ANALYTICS: {
    ...
    GENERATE_ID: '/customers/generate-id',
    CHECK_PHONE: '/customers/check-phone',
  ...
  NOTIFICATIONS: {
    ...
    TEMPLATE_CLONE: (id: string) => `/notifications/templates/${id}/clone`,
    TEMPLATE_PREVIEW: (id: string) => `/notifications/templates/${id}/preview`,
    CAMPAIGNS: '/notifications/campaigns',
    CAMPAIGN_SEND: (id: string) => `/notifications/campaigns/${id}/send`,
